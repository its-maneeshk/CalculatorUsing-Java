...
public class AngleCalculationChoice {
    public void chooser() {

        ToDegreeRadian toDegreeRadianGrade = new ToDegreeRadian();
        ...
        while (true) {
            ...
            try {
                ...
                switch (choice) {
                    case 1:
                        toDegreeRadianGrade.executeDegreeToRadian();
                        break;
                    case 2:
                        toDegreeRadianGrade.executeRadianToDegree();
                        break;
                    case 3:
